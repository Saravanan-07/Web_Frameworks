...
public class StudentController {
     ...
     public List<Student> findbyfirstnamelastname(@PathVariable("firstname") String firstname) {
          return r.findbyfirstnamelastname(firstname,lastname);
     }
     @PutMapping("/updatelastname/{firstname}/{lastname}")
     public String updateFirstNames(@PathVariable String firstname, @PathVariable String ) {
          return studentService.updatelastnamejpql(firstname,lastname)+"Student(s) updated successfully";
     }
